 ...
 * @LastEditTime: 2022-11-10 16:38:11
 * @FilePath: /zhong.lu/scripts/portal.js
 * @Description: 偷懒界翘楚
 * @Bio：https://L.Lcc.cc
 * Copyright (c) 2022 by 卢东东 xjoylu@gmail.com, All Rights Reserved. 
 */
'use strict'
...
function Portal (sites) {
  ...
  function _readme () {
    return ` <p class='readme'> Zhong.Lu Union - 中路联盟是 <a href="https://zhaodao.ai" target='_blank'>找到AI</a> 发起的致力于构建更加繁荣的互联网创作生态的流量共享项目，我们期望中国本土的创作者可以共同“戴上” Makers Union - 创作者联盟指环，以向大众分享彼此的流量、idea 和作品。欢迎更多优秀的中国创作者加入我们的联盟；）</p><br>
